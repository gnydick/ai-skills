...
## tiers (key `tiers`)
1. Ask: decide the tiers together, or have Claude measure the suite and propose a baseline.
...
- Re-running this item when the project already has an answer is not designed yet (open question).
