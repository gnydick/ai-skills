...
// spelling of what install.mjs stages, read by install.mjs (what it stages) and by tiers.mjs (what a
...
// this one. Entries are paths relative to the project root, POSIX-separated: a file, or a directory
// whose whole tree is machinery's.
import { INBOX, SPEC_INBOX, DOCS_DIR, SPECS_DIR, MACHINERY_DIR, RULES_DIR } from './layout.mjs';
